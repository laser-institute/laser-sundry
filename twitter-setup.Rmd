...
3.  On the next page, click on "Apply for a

![](img/twitter-developer.png){width="80%"}

4.  Next, you'll be asked to select a developer account \#UseCase. For the LASER Institute, **I recommend selecting `Student` under the `Academic` use case to facilitate approval.**
